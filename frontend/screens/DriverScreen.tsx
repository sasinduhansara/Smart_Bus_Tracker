...
export default function DriverScreen() {
  ...
  const sendLocation = async () => {
    ...
    try {
      ...
      Alert.alert('Error', 'Could not send location. Make sure socket is connected.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const endTrip = async () => {
    ...
    try {
      ...
      setLiveBus(null);
      Alert.alert('Trip Ended', 'Passenger notifications have been sent.');
      const map = await fetchActiveBuses();
      setBuses(map);
    } catch {
