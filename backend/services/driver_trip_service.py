...
def serialize_location(value: Any) -> dict[str, Any] | None:
    ...
    location = {
        "lat": value.get("lat"),
        "lng": value.get("lng"),
        "rawLatitude": value.get("rawLatitude"),
        "rawLongitude": value.get("rawLongitude"),
        "displayLatitude": value.get("displayLatitude"),
        "displayLongitude": value.get("displayLongitude"),
        "distanceFromRouteMeters": value.get("distanceFromRouteMeters"),
        "isRouteDeviation": value.get("isRouteDeviation"),
